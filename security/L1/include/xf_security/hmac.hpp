...
#pragma HLS dataflow
    ...
    hls::stream<ap_uint<dataW> > mergeKipadStrm;
#pragma HLS stream variable = mergeKipadStrm depth = 32
...
#pragma HLS dataflow
    ...
    hls::stream<ap_uint<dataW> > mergeKopadStrm;
#pragma HLS stream variable = mergeKopadStrm depth = 32
